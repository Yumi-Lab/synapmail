...
check('an address is one term', parseQuery('bruno@3d-expert.fr'), ['bruno@3d-expert.fr'])
...
check('body is never searched (IONOS returns 0 and voids the OR)', SEARCH_FIELDS.includes('body'), false)
